...
def make(
    ...
    from morality_gym._morality_chain.setup import make as morality_chain_make
    ...
    if env_category == "Trolley":
        # TROLLEY #
        from morality_gym._environments.trolley.setup import make as trolley_make
...
def get_supported(
    ...
    from morality_gym._environments.trolley.supported_envs import SUPPORTED_ENVS
