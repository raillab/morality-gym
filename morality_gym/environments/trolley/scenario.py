...
from morality_gym.environments.core.action import SubActionEnum, ActionEnum
from morality_gym.environments.core.custom_types import PosType
from morality_gym.environments.core.dynamics.interact import push_fn
from morality_gym.environments.core.entity.character import CharacterEntity
from morality_gym.environments.core.entity.interactable import LeverEntity, LinkedNearbyEntity
from morality_gym.environments.core.norm_functions.setup import create_norm_fn, create_multi_norm_funcs
from morality_gym.environments.core.scenario import BaseScenario
from morality_gym.environments.trolley.dynamics import RailwayDynamics
from morality_gym.environments.trolley.entity import Railway
from morality_gym.utils.common import copy_to_dict, comp_base_path, join_paths
...
def easy_create_scenario(
    ...
    #################
    # OUTCOME #
    from morality_gym.environments.trolley.norm_functions.outcome import outcome_norm_fn
    ...
    # }
    # UTILITY #
    from morality_gym.environments.trolley.norm_functions.utility import n_harm_norm_fn
    ...
    # ACTION #
    from morality_gym.environments.trolley.norm_functions.action import action_norm_fn
    event_to_action_fns = {
        "personal": action_norm_fn
    }

    # CAUSAL #
    from morality_gym.environments.trolley.norm_functions.causal import cause_harm_norm_fn
    event_to_causal_fns = {
...
def easy_create_from_config(
    ...
    #  'environments/trolleys/configs/variants'
...
def main():
    ...
    from morality_gym.environments.core.env import BaseEnv
    from morality_gym.environments.core.env import interactive
    env = BaseEnv(world, valid_actions=valid_actions, obs_entities=obs_entities, obs_type=dict)
    interactive(env)

# def main():
#     from morality_gym.environments.core.world import interactive
#
