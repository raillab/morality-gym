...
class RailSwitch(Rail):
    def __init__(
        ...
        # self.rail_orients: Optional[List[Tuple[str, str]]] = None
        #
        # def to_rot_fn(entity: BaseEntity) -> int:
        ...
        #
        # self.to_rot_fn = to_rot_fn
        # self.rail_orients: Optional[List[Optional[Tuple[str, str]]]] = [None for _ in range(self._n_connect_rails)]
        # ("L", "R")
    ...
    def comp_rail_orients(self):
        ...
        self.rail_orients = [(prev_rail_dir, curr_connect_dir) for curr_connect_dir in connect_rail_dirs]
        # TODO: Validation
        return self.rail_orients
...
class Trolley(BaseEntity):
    def __init__(
        ...
        def to_rot_fn(entity):
            direction = self._curr_rail.direction
            if direction in {"L", "R"}:
                rot = 0
            else:
                rot = 90
