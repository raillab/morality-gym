...
from morality_gym.morality_chain.norm import UtilityNorm
    ...
    def __init__(
        ...
        if information_mode == "full":
            ...
            if morality_chain.salient_norms is None:
                raise ValueError("morality_chain.salient_norms cannot be None when information_mode='full'")
            ...
            if self._morality_chain.global_utility_bounds is None:
                raise ValueError("morality_chain.global_utility_bounds cannot be None when information_mode='minimal'")
